                            ...
                            <div className="flex-center">
                                {
                                    localStorage.role === "admin" &&
                                        <>
                                            ...
                                            {/*<Link className="btn-navbar mouse-cursor btn-underLine dropdown" to="/assign-album">*/}
                                            {/*    <span>Assign to User</span>*/}
                                                ...
                                                {/*<div className="dropdown-content">*/}
                                                {/*    <Link className="btn-underLine" to="/assign-album">*/}
                                                {/*        <div className="menu-txt mouse-cursor">Albums</div>*/}
                                                {/*    </Link>*/}
                                                {/*    <Link className="btn-underLine" to="/assign-track">*/}
                                                {/*        <div className="menu-txt mouse-cursor">Tracks</div>*/}
                                                {/*    </Link>*/}
                                                {/*</div>*/}
                                            </Link>
                                        </>
...

                                {
                                    localStorage.role === 'publisher' &&
                                        <>
                                            ...
                                            {/*<Link className="btn-navbar mouse-cursor btn-underLine dropdown" to="/user/reports">*/}
                                ...
                                <div className="btn-underLine btn-navbar mouse-cursor btn-sign" onClick={this.logOut}>Log out</div>
                            </div>
